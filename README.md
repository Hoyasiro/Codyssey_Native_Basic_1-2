...
| 실제 프롬프트 원문 | (ElevenLabs TTS - Eleven v3 사용, 중년 남성 목소리 옵션 선택) [Whisper] 야구선수로 키우려면 공부는 포기해야 한다며? | (Sora-2, 네이토) A handsome 10-year-old Korean boy with glasses, youth baseball pitcher, 
