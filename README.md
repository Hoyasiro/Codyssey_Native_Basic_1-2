...
| 사용 AI 도구 | 영상: Kling (텍스트→영상) + 이미지: Gemini 이미지 (배경 원본) | 영상: Runway (이미지→영상 변환) | 영상: Kling 또는 Runway (텍스트/이미지→영상 변환) | 이미지: DALL·E (배경/전환 연출) + 실제 팀 로고 합성 |
